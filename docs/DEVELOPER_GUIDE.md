...
>
> **موازنة نقدية (`cash_budget`, 2026-08-20):** بعد البنوك في الشريط. لقطة أرصدة حتى نهاية الفترة — الالتزامات في جدول واحد (اسم الحساب الفرعي فقط + مركز التكلفة؛ الرصيد المشترك = سطر لكل مركز). الإجماليات أعلى التقرير = بنوك `12101` + خزينة `12102` + مستخلصات `12201`. **بعد الاعتماد:** حذف المستبعد تماماً · توزيع البنوك + الصناديق (بدون العهد وبدون المستخلصات) حسب وزن رصيد كل حساب · جدول إجمالي التوزيع لكل مركز تكلفة (شاشة + طباعة). **لا قيد GL.**
