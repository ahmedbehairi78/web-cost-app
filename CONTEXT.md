...
**آخر تحديث:** 2026-08-21 (اعتماد تسوية العهدة من تفاصيل السجل · إغلاق معاينة الطباعة لا يُسقط الجلسة)
...
| **موازنة نقدية** | — | Postgres `cash_budget_periods` / `cash_budget_lines` — أرصدة GL حتى نهاية الفترة · جدول التزامات: اسم الحساب الفرعي + المشروع + نسبة التوزيع · بعد الاعتماد: حذف المستبعد · توزيع **بنوك 12101 فقط** (لا عهد/صناديق 12102) وبحد الالتزامات · جدول إجمالي لكل مشروع · **بدون قيد** |
