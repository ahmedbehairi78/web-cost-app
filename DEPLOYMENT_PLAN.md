...
- **2026-08-21:** موازنة نقدية — بعد الاعتماد: سداد من بنوك `12101` فقط (لا صناديق/عهد `12102`) وبحد الالتزامات. أعد تشغيل API ثم أعد فتح الفترة المعتمدة (أو تحديث الاقتراح).
