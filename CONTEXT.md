...
| **موازنة نقدية** | — | Postgres `cash_budget_periods` / `cash_budget_lines` — أرصدة GL حتى نهاية الفترة · جدول التزامات: اسم الحساب الفرعي + المشروع + نسبة التوزيع · بعد الاعتماد: حذف المستبعد · توزيع بنوك+صناديق حسب وزن الحساب · جدول إجمالي لكل مشروع · **بدون قيد** |
