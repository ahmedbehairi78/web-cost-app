...
**آخر تحديث:** 2026-08-21 (محاذاة خلايا الجدول في شريط تنسيق الطباعة · اعتماد تسوية العهدة من تفاصيل السجل · إغلاق معاينة الطباعة لا يُسقط الجلسة)
...
| طباعة الشركة | `company_info` | **`PrintSettingsPanel`** (إعدادات العرض، admin): اسم/عنوان/ضريبة/شعار/نص تذييل فقط — **تصميم الطباعة من شريط تنسيق التقارير** (يشمل محاذاة خلايا الجدول) |
