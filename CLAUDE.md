...
- **Cash budget Excel:** من معاينة الطباعة (`تصدير Excel`) — شيت واحد عبر [`exportExcel.ts`](src/lib/reportDocument/exportExcel.ts) يضم الملخص + الالتزامات + المشاريع + حدود العهد.
