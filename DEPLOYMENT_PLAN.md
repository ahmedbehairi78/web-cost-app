...
- **2026-08-20:** إشعار تحديث Railway = **الآن أو لاحقاً** (لا إغلاق فور ظهور الإشعار). موديول **بدجيت الالتزامات** (`cash_budget`) — تخطيط فقط (لا GL) · migration `20260820120000_cash_budget` + `chart_of_accounts.min_balance`. يلزم `migrate deploy` على Railway.
