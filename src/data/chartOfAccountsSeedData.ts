export interface SeedAccount {  accountCode: string;
  accountName: string;
...
export const CHART_OF_ACCOUNTS_SEED: SeedAccount[] = [
  ...
  { accountCode: '12303', accountName: 'سلف العاملين',          accountNameEn: 'Employee Advances',           parentCode: '123', type: 'asset', isGroup: true, status: 'active' },
  ...
  { accountCode: '21405', accountName: 'ضريبة كسب العمل (دائن)',                    accountNameEn: 'Payroll Income Tax Payable',       parentCode: '214', type: 'liability', isGroup: true, status: 'active' },
  ...
  { accountCode: '21405001', accountName: 'ضريبة كسب العمل - دائن',                          accountNameEn: 'Payroll Income Tax Payable',          parentCode: '21405', type: 'liability', isGroup: false, status: 'active' },
  ...
  { accountCode: '21501002', accountName: 'جزاءات وخصومات محتجزة',                           accountNameEn: 'Withheld Penalties',                  parentCode: '21501', type: 'liability', isGroup: false, status: 'active' },
  { accountCode: '21501003', accountName: 'رواتب وأجور مستحقة الدفع',                        accountNameEn: 'Salaries & Wages Payable',            parentCode: '21501', type: 'liability', isGroup: false, status: 'active' },
  ...
  { accountCode: '314', accountName: 'جاري الشركاء',    accountNameEn: "Partners' Current Accounts", parentCode: '31', type: 'equity', isGroup: true, status: 'active' },
  ...
  { accountCode: '31401', accountName: 'جاري الشركاء - مسحوبات', accountNameEn: "Partners' Current Accounts", parentCode: '314', type: 'equity', isGroup: true, status: 'active' },
  ...
  { accountCode: '31401001', accountName: 'جاري الشركاء',       accountNameEn: 'Partner Current Account', parentCode: '31401', type: 'equity', isGroup: false, status: 'active' },
