...
| **موازنة نقدية** | — | Postgres `cash_budget_periods` / `cash_budget_lines` — أرصدة GL حتى نهاية الفترة · جدول التزامات: اسم الحساب الفرعي + مركز التكلفة (سطر لكل مركز) · بعد الاعتماد: توزيع بنوك+صناديق (بدون عهد/مستخلصات) حسب وزن الحساب · **بدون قيد** |
