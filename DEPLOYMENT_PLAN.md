...
**آخر تحديث:** 2026-07-29 — قائمة الدخل (هيكل إقفال + استبعاد `fiscal_pl_close` + وضع تحليلي) · 2026-07-27 — إقفال قائمة الدخل + قيد افتتاحي · 2026-07-26 — قفل الفترات المحاسبية · 2026-07-25 — Electron multi-window · 2026-06-26 Shell · Settings admin · General Settings · Release **v1.0.3**.
