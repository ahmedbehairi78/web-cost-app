...
**تحديث Railway (Electron):** لا إعادة تحميل مفاجئة بعد النشر. جرس التنبيهات يعرض «يتوفر تحديث جديد» مع **تحديث الآن** أو **لاحقاً** — العمل يستمر حتى يختار المستخدم الآن (`src/lib/spaBuild.ts`). لا `app.quit` ولا تطبيق عند مجرد ظهور الإشعار.
