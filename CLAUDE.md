...
الالتزامات = أرصدة **دائنة** على أوراق الموردين `21101…` ومقاولي الباطن `21102…` + رواتب مستحقة `21501…` + تعويض عهدة `12102…` إن قلّ الرصيد عن `min_balance`. الجدول يعرض **اسم الحساب الفرعي فقط** + **المشروع** — إن اشترك الرصيد يظهر سطر لكل مشروع/مركز. بدون عنوان «التزامات (مستحق علينا)». **بعد الاعتماد:** تُحذف البنود المستبعدة · يُوزَّع رصيد البنوك `12101` + الصناديق حسب وزن الحساب · عمود **نسبة التوزيع** · جدول أسفل التقرير لإجمالي التوزيع لكل مشروع. لا قيد يومية.
