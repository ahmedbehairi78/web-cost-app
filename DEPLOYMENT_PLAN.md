...
- **2026-08-21:** موازنة نقدية — استعاضة العهدة من رصيد اليومية مقابل الحد الأدنى (بند التزام يُسدَّد من بنوك 12101) · سداد من بنوك فقط (لا 12102) وبحد الالتزامات. أعد تشغيل API ثم احفظ الحد على فترة مسودة.
