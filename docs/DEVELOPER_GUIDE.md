...
| أسهم ←→↑↓ · Enter · Tab | بين الخلايا داخل أي `<table>` فيه حقول قابلة للتحرير (مستخلصات، قيد يومية، رواتب، …) |
| أسهم أفقية أثناء التحرير | إن لم يكن النص محدداً بالكامل تبقى لتحريك المؤشر داخل الحقل |
