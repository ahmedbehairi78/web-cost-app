...
export function buildSpaUpdateNotificationItem(now = new Date()): AppNotificationItem {
  return {
    ...
    priority: 'urgent',
    titleAr: 'يتوفر تحديث جديد للتطبيق — اضغط للتحديث ثم ستظهر شاشة الدخول',
    titleEn: 'A new app update is available — click to update, then the login screen will open',
