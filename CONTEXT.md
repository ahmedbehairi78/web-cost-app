...
**آخر تحديث:** 2026-08-20 (تحديث Railway: الآن أو لاحقاً · موازنة نقدية)
...
**تحديث Railway (Electron):** حوار أصلي في القشرة **الآن أو لاحقاً** (لاحقاً = الافتراضي) — لا يعتمد على كاش الواجهة. التحديث يعيد تحميل النوافذ **مع بقاء الجلسة**. لا `app.quit` عند 401 أثناء النشر. جرس التنبيهات يبقى اختيارياً داخل التطبيق.
